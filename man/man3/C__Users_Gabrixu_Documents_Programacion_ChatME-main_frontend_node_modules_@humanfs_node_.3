.TH "frontend/node_modules/@humanfs/node Directory Reference" 3 "Version 0.1" "Chat-ME!" \" -*- nroff -*-
.ad l
.nh
.SH NAME
frontend/node_modules/@humanfs/node Directory Reference
.SH SYNOPSIS
.br
.PP
...
.SH "Description"
.PP
The \fRhfs\fP bindings for use in Node\&.js and Node\&.js-compatible runtimes\&.
...
.SH "Usage"
.PP
The easiest way to use hfs in your project is to import the \fRhfs\fP object:
...
.PP
If you'd like to create your own instance, import the \fRNodeHfs\fP constructor:
...
.PP
If you'd like to use just the impl, import the \fRNodeHfsImpl\fP constructor:
...
.PP
.IP "\(bu" 2
\fRENOENT\fP - in most cases, these errors are handled silently\&.
.IP "\(bu" 2
\fRENFILE\fP and \fREMFILE\fP - calls that result in these errors are retried for up to 60 seconds before giving up for good\&.
.PP
.SH "License"
.PP
Apache 2\&.0 
