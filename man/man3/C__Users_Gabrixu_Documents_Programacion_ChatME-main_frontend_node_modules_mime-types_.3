.TH "frontend/node_modules/mime-types Directory Reference" 3 "Version 0.1" "Chat-ME!" \" -*- nroff -*-
.ad l
.nh
.SH NAME
frontend/node_modules/mime-types Directory Reference
.SH SYNOPSIS
.br
.PP
...
.PP
.IP "\(bu" 2
\fBNo fallbacks\&.\fP Instead of naively returning the first available type, \fRmime-types\fP simply returns \fRfalse\fP, so do \fRvar type = mime\&.lookup('unrecognized') || 'application/octet-stream'\fP\&.
.IP "\(bu" 2
No \fRnew Mime()\fP business, so you could do \fRvar lookup = require('mime-types')\&.lookup\fP\&.
.IP "\(bu" 2
No \fR\&.define()\fP functionality
.IP "\(bu" 2
Bug fixes for \fR\&.lookup(path)\fP
.PP
