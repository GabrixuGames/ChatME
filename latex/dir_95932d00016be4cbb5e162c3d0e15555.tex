\doxysection{frontend/node\+\_\+modules/minipass Directory Reference}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555}{}\label{dir_95932d00016be4cbb5e162c3d0e15555}\index{frontend/node\_modules/minipass Directory Reference@{frontend/node\_modules/minipass Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4501}{}\doxysubsection{\texorpdfstring{minipass}{minipass}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4501}
...
There is a {\ttfamily read()} method, but it\textquotesingle{}s much more efficient to consume data from this stream via {\ttfamily \textquotesingle{}data\textquotesingle{}} events or by calling {\ttfamily pipe()} into some other stream. Calling {\ttfamily read()} requires the buffer to be flattened in some cases, which requires copying memory.
...
\end{DoxyItemize}\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4502}{}\doxysubsection{\texorpdfstring{Usage in Type\+Script}{Usage in Type\+Script}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4502}
...
Emitting/handling events that aren\textquotesingle{}t declared in this way is fine, but the arguments will be typed as {\ttfamily unknown}.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4503}{}\doxysubsection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4503}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4504}{}\doxysubsubsection{\texorpdfstring{Timing}{Timing}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4504}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4505}{}\doxysubsubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4505}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4506}{}\doxysubsubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4506}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4507}{}\doxysubsubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4507}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4508}{}\doxysubsubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4508}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4509}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4509}
One hazard of immediately emitting {\ttfamily \textquotesingle{}end\textquotesingle{}} is that you may not yet have had a chance to add a listener. In order to avoid this hazard, Minipass streams safely re-\/emit the {\ttfamily \textquotesingle{}end\textquotesingle{}} event if a new listener is added after {\ttfamily \textquotesingle{}end\textquotesingle{}} has been emitted.

Ie, if you do {\ttfamily stream.\+on(\textquotesingle{}end\textquotesingle{}, some\+Function)}, and the stream has already emitted {\ttfamily end}, then it will call the handler right away. (You can think of this somewhat like attaching a new {\ttfamily .then(fn)} to a previously-\/resolved Promise.)

To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the {\ttfamily \textquotesingle{}end\textquotesingle{}} event whenever it is emitted.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4510}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4510}
The most recent error object passed to the {\ttfamily \textquotesingle{}error\textquotesingle{}} event is stored on the stream. If a new {\ttfamily \textquotesingle{}error\textquotesingle{}} event handler is added, and an error was previously emitted, then the event handler will be called immediately (or on {\ttfamily process.\+next\+Tick} in the case of async streams).

This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4511}{}\doxysubsubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4511}
...
The same caveat applies to {\ttfamily on(\textquotesingle{}data\textquotesingle{})} event listeners. The first one added will {\itshape immediately} receive all of the data, leaving nothing for the second\+:
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4512}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4512}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4513}{}\doxysubsubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4513}
...
\item {\ttfamily signal} An {\ttfamily Abort\+Signal} that will cause the stream to unhook itself from everything and become as inert as possible. Note that providing a {\ttfamily signal} parameter will make {\ttfamily \textquotesingle{}error\textquotesingle{}} events no longer throw if they are unhandled, but they will still be emitted to handlers if any are attached.
\end{DoxyItemize}\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4514}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4514}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4515}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4515}
...
\item {\ttfamily options.\+proxy\+Errors} -\/ Boolean, proxy {\ttfamily error} events from the source stream to the destination stream. Note that errors are {\itshape not} proxied after the pipeline terminates, either due to the source emitting {\ttfamily \textquotesingle{}end\textquotesingle{}} or manually unpiping with {\ttfamily src.\+unpipe(dest)}. Default {\ttfamily false}.
\end{DoxyItemize}
\item {\ttfamily on(ev, fn)}, {\ttfamily emit(ev, fn)} -\/ Minipass streams are Event\+Emitters. Some events are given special treatment, however. (See below under "{}events"{}.)
...
\item {\ttfamily destroy(\mbox{[}er\mbox{]})} -\/ Destroy the stream. If an error is provided, then an {\ttfamily \textquotesingle{}error\textquotesingle{}} event is emitted. If the stream has a {\ttfamily close()} method, and has not emitted a {\ttfamily \textquotesingle{}close\textquotesingle{}} event yet, then {\ttfamily stream.\+close()} will be called. Any Promises returned by {\ttfamily .promise()}, {\ttfamily .collect()} or {\ttfamily .concat()} will be rejected. After being destroyed, writing to the stream will emit an error. No more data will be emitted if the stream is destroyed, even if it was previously buffered.
\end{DoxyItemize}\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4516}{}\doxysubsubsection{\texorpdfstring{Properties}{Properties}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4516}
...
\end{DoxyItemize}\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4517}{}\doxysubsubsection{\texorpdfstring{Events}{Events}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4517}
...
\item {\ttfamily prefinish} An end-\/ish event that follows the same logic as {\ttfamily end} and is emitted in the same conditions where {\ttfamily end} is emitted. Emitted after {\ttfamily \textquotesingle{}end\textquotesingle{}}.
\item {\ttfamily finish} An end-\/ish event that follows the same logic as {\ttfamily end} and is emitted in the same conditions where {\ttfamily end} is emitted. Emitted after {\ttfamily \textquotesingle{}prefinish\textquotesingle{}}.
\item {\ttfamily close} An indication that an underlying resource has been released. Minipass does not emit this event, but will defer it until after {\ttfamily end} has been emitted, since it throws off some stream libraries otherwise.
...
\end{DoxyItemize}\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4518}{}\doxysubsubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4518}
...
\end{DoxyItemize}\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4519}{}\doxysubsection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4519}
Here are some examples of things you can do with Minipass streams.\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4520}{}\doxysubsubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4520}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4521}{}\doxysubsubsection{\texorpdfstring{collecting}{collecting}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4521}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4522}{}\doxysubsubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4522}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4523}{}\doxysubsubsection{\texorpdfstring{iteration}{iteration}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4523}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4524}{}\doxysubsubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4524}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4525}{}\doxysubsubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4525}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4526}{}\doxysubsubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4526}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4527}{}\doxysubsubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4527}
...
\end{DoxyCode}
\hypertarget{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4528}{}\doxysubsubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{dir_95932d00016be4cbb5e162c3d0e15555_autotoc_md4528}
