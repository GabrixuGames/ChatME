\doxysection{frontend/node\+\_\+modules/package-\/json-\/from-\/dist Directory Reference}
\hypertarget{dir_a34d1d4f81b57258a384bfbe2df8104d}{}\label{dir_a34d1d4f81b57258a384bfbe2df8104d}\index{frontend/node\_modules/package-\/json-\/from-\/dist Directory Reference@{frontend/node\_modules/package-\/json-\/from-\/dist Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_a34d1d4f81b57258a384bfbe2df8104d_autotoc_md4699}{}\doxysubsection{\texorpdfstring{package-\/json-\/from-\/dist}{package-\/json-\/from-\/dist}}\label{dir_a34d1d4f81b57258a384bfbe2df8104d_autotoc_md4699}
Sometimes you want to load the {\ttfamily package.\+json} into your Type\+Script program, and it\textquotesingle{}s tempting to just {\ttfamily import \textquotesingle{}../package.json\textquotesingle{}}, since that seems to work.
...
This module helps by just finding the package.\+json file appropriately, and reading and parsing it in the most normal fashion.\hypertarget{dir_a34d1d4f81b57258a384bfbe2df8104d_autotoc_md4700}{}\doxysubsection{\texorpdfstring{Caveats}{Caveats}}\label{dir_a34d1d4f81b57258a384bfbe2df8104d_autotoc_md4700}
...
If you build to some other location, then you\textquotesingle{}ll need a different approach. (Feel free to fork this module and make it your own, or just put the code right inline, there\textquotesingle{}s not much of it.)\hypertarget{dir_a34d1d4f81b57258a384bfbe2df8104d_autotoc_md4701}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{dir_a34d1d4f81b57258a384bfbe2df8104d_autotoc_md4701}
