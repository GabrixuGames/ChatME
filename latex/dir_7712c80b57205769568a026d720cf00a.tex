...
\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4879}{}\doxysubsection{\texorpdfstring{postcss-\/import}{postcss-\/import}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4879}
...
\end{DoxyItemize}\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4880}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4880}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/D\ postcss-\/import}

\end{DoxyCode}
\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4881}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4881}
...
Checkout the \mbox{[}tests\mbox{]}(test) for more examples.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4882}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4882}
\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4883}{}\doxysubsubsection{\texorpdfstring{{\ttfamily filter}}{{\ttfamily filter}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4883}
Type\+: {\ttfamily Function} ~\newline
 Default\+: {\ttfamily () =\texorpdfstring{$>$}{>} true}

Only transform imports for which the test function returns {\ttfamily true}. Imports for which the test function returns {\ttfamily false} will be left as is. The function gets the path to import as an argument and should return a boolean.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4884}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily root}}{{\ttfamily root}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4884}
Type\+: {\ttfamily String} ~\newline
...
Define the root where to resolve path (eg\+: place where {\ttfamily node\+\_\+modules} are). Should not be used that much. ~\newline
 \+\_\+\+Note\+: nested {\ttfamily @import} will additionally benefit of the relative dirname of imported files.\+\_\+\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4885}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path}}{{\ttfamily path}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4885}
Type\+: {\ttfamily String\texorpdfstring{$\vert$}{|}\+Array} ~\newline
 Default\+: {\ttfamily \mbox{[}\mbox{]}}

A string or an array of paths in where to look for files.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4886}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily plugins}}{{\ttfamily plugins}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4886}
Type\+: {\ttfamily Array} ~\newline
 Default\+: {\ttfamily undefined}

An array of plugins to be applied on each imported files.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4887}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily resolve}}{{\ttfamily resolve}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4887}
Type\+: {\ttfamily Function} ~\newline
 Default\+: {\ttfamily null}

You can provide a custom path resolver with this option. This function gets {\ttfamily (id, basedir, import\+Options)} arguments and should return a path, an array of paths or a promise resolving to the path(s). If you do not return an absolute path, your path will be resolved to an absolute path using the default resolver. You can use \href{https://github.com/substack/node-resolve}{\texttt{resolve}} for this.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4888}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily load}}{{\ttfamily load}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4888}
Type\+: {\ttfamily Function} ~\newline
 Default\+: null

You can overwrite the default loading way by setting this option. This function gets {\ttfamily (filename, import\+Options)} arguments and returns content or promised content.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4889}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily skip\+Duplicates}}{{\ttfamily skip\+Duplicates}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4889}
Type\+: {\ttfamily Boolean} ~\newline
 Default\+: {\ttfamily true}

By default, similar files (based on the same content) are being skipped. It\textquotesingle{}s to optimize output and skip similar files like {\ttfamily normalize.\+css} for example. If this behavior is not what you want, just set this option to {\ttfamily false} to disable it.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4890}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily add\+Modules\+Directories}}{{\ttfamily add\+Modules\+Directories}}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4890}
Type\+: {\ttfamily Array} ~\newline
 Default\+: {\ttfamily \mbox{[}\mbox{]}}
...
This option only influences imports without a layer name. Without this option the plugin will warn on anonymous layers.\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4892}{}\doxysubsubsubsection{\texorpdfstring{Example with some options}{Example with some options}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4892}
...
\end{DoxyCode}
\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4893}{}\doxysubsection{\texorpdfstring{{\ttfamily dependency} Message Support}{{\ttfamily dependency} Message Support}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4893}
...
\DoxyHorRuler{0}
\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4895}{}\doxysubsection{\texorpdfstring{CONTRIBUTING}{CONTRIBUTING}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4895}
...
\end{DoxyItemize}\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4896}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4896}
\hypertarget{dir_7712c80b57205769568a026d720cf00a_autotoc_md4897}{}\doxysubsection{\texorpdfstring{\mbox{[}License\mbox{]}(LICENSE)}{\mbox{[}License\mbox{]}(LICENSE)}}\label{dir_7712c80b57205769568a026d720cf00a_autotoc_md4897}
