...
\end{DoxyCode}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3901}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3901}
...
\end{DoxyCode}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3902}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3902}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3903}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily js\+Tokens}}{{\ttfamily js\+Tokens}}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3903}
...
The next match is always directly after the previous.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3904}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily var token = match\+To\+Token(match)}}{{\ttfamily var token = match\+To\+Token(match)}}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3904}
...
Whitespace includes both line terminators and other whitespace.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3905}{}\doxysubsection{\texorpdfstring{ECMAScript support}{ECMAScript support}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3905}
...
Currently, ECMAScript 2018 is supported.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3906}{}\doxysubsection{\texorpdfstring{Invalid code handling}{Invalid code handling}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3906}
...
Strings may contain invalid escape sequences.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3907}{}\doxysubsection{\texorpdfstring{Limitations}{Limitations}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3907}
Tokenizing Java\+Script using regexes—in fact, \+\_\+one single regex\+\_\+—won’t be perfect. But that’s not the point either.

You may compare js\+Tokens with \href{http://esprima.org/}{\texttt{esprima}} by using {\ttfamily esprima-\/compare.\+js}. See {\ttfamily npm run esprima-\/compare}!\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3908}{}\doxysubsubsubsection{\texorpdfstring{Template string interpolation}{Template string interpolation}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3908}
...
Matching template string interpolations requires recursive balancing of {\ttfamily \{} and {\ttfamily \}}—something that Java\+Script regexes cannot do. Only one level of nesting is supported.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3909}{}\doxysubsubsubsection{\texorpdfstring{Division and regex literals collision}{Division and regex literals collision}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3909}
...
If the end of a statement looks like a regex literal (even if it isn’t), it will be treated as one. Otherwise it should work as expected (if you write sane code).\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3910}{}\doxysubsubsubsection{\texorpdfstring{ES2018}{ES2018}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3910}
...
These things would be nice to do, but are not critical. They probably have to wait until the oldest maintained Node.\+js LTS release supports those features.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3911}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md3911}
