\doxysection{frontend/node\+\_\+modules/use-\/sidecar Directory Reference}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454}{}\label{dir_a03221562eb905056bf27ed9059e3454}\index{frontend/node\_modules/use-\/sidecar Directory Reference@{frontend/node\_modules/use-\/sidecar Directory Reference}}


\doxysubsection{Detailed Description}
 \doxysubsection*{🏎 side car}
...
\end{DoxyItemize}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7433}{}\doxysubsubsection{\texorpdfstring{Terminology\+:}{Terminology\+:}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7433}
...
{\ttfamily UI} is a {\itshape view}, {\ttfamily sidecar} is the {\itshape logic} for it. Like Batman(\+UI) and his sidekick Robin(effects).\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7434}{}\doxysubsubsection{\texorpdfstring{Concept}{Concept}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7434}
...
\end{DoxyItemize}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7435}{}\doxysubsubsection{\texorpdfstring{Rules}{Rules}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7435}
...
\begin{quote}
except {\ttfamily medium.\+read}, which synchronously read the data from a medium, and {\ttfamily medium.\+assing\+Sync\+Medium} which changes {\ttfamily use\+Medium} to be sync. \end{quote}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7436}{}\doxysubsubsection{\texorpdfstring{SSR and usage tracking}{SSR and usage tracking}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7436}
...
Thus -\/ no usage tracking, and literally no SSR. It\textquotesingle{}s just skipped.\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7437}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7437}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7438}{}\doxysubsubsection{\texorpdfstring{create\+Medium()}{create\+Medium()}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7438}
...
\begin{quote}
! For consistence {\ttfamily use\+Medium} is async -\/ sidecar load status should not affect function behavior, thus effect would be always executed at least in the "{}next tick"{}. You may alter this behavior by using {\ttfamily medium.\+assing\+Sync\+Medium}. \end{quote}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7439}{}\doxysubsubsection{\texorpdfstring{export\+Sidecar(medium, component)}{export\+Sidecar(medium, component)}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7439}
...
\end{DoxyItemize}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7440}{}\doxysubsubsection{\texorpdfstring{sidecar(importer)}{sidecar(importer)}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7440}
...
\end{DoxyItemize}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7441}{}\doxysubsubsubsection{\texorpdfstring{Importing {\ttfamily exported\+Sidecar}}{Importing {\ttfamily exported\+Sidecar}}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7441}
Would require additional prop to be set -\/ {\ttfamily \texorpdfstring{$<$}{<}Sidecar side\+Car=\{effect\+Car\} /\texorpdfstring{$>$}{>}}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7442}{}\doxysubsubsection{\texorpdfstring{use\+Sidecar(importer)}{use\+Sidecar(importer)}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7442}
...
\end{DoxyItemize}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7443}{}\doxysubsubsubsection{\texorpdfstring{Importing {\ttfamily exported\+Side\+Car}}{Importing {\ttfamily exported\+Side\+Car}}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7443}
...
\end{DoxyCode}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7444}{}\doxysubsubsection{\texorpdfstring{render\+Car(\+Component)}{render\+Car(\+Component)}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7444}
...
\end{DoxyItemize}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7445}{}\doxysubsubsection{\texorpdfstring{set\+Config(config)}{set\+Config(config)}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7445}
...
\end{DoxyCode}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7446}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7446}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7447}{}\doxysubsubsection{\texorpdfstring{Deferred effect}{Deferred effect}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7447}
Let\textquotesingle{}s imagine -\/ on element focus you have to do "{}something"{}, for example focus anther element\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7448}{}\doxysubsubsubsubsection{\texorpdfstring{Original code}{Original code}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7448}
...
\end{DoxyCode}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7449}{}\doxysubsubsubsubsection{\texorpdfstring{Sidecar code}{Sidecar code}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7449}
...
{\bfseries{Example}}\+: \href{https://github.com/theKashey/react-focus-lock/blob/8c69c644ecfeed2ec9dc0dc4b5b30e896a366738/src/Lock.js\#L48}{\texttt{Effect for react-\/focus-\/lock}} -\/ 1kb UI, 4kb sidecar\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7450}{}\doxysubsubsubsection{\texorpdfstring{Medium callback}{Medium callback}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7450}
Like a library level code splitting\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7451}{}\doxysubsubsubsubsection{\texorpdfstring{Original code}{Original code}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7451}
...
\end{DoxyCode}
\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7452}{}\doxysubsubsubsubsection{\texorpdfstring{Sidecar code}{Sidecar code}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7452}
...
{\bfseries{Example}}\+: \href{https://github.com/theKashey/react-focus-lock/blob/8c69c644ecfeed2ec9dc0dc4b5b30e896a366738/src/MoveFocusInside.js\#L12}{\texttt{Callback API for react-\/focus-\/lock}}\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7453}{}\doxysubsubsubsection{\texorpdfstring{Split effects}{Split effects}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7453}
Lets take an example from a Google -\/ Calendar app, with view and logic separated. To be honest -\/ it\textquotesingle{}s not easy to extract logic from application like calendar -\/ usually it\textquotesingle{}s tight coupled.\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7454}{}\doxysubsubsubsubsection{\texorpdfstring{Original code}{Original code}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7454}
...
\end{DoxyCode}
 \hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7455}{}\doxysubsubsubsubsection{\texorpdfstring{Sidecar code}{Sidecar code}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7455}
...
{\bfseries{Example}}\+: \href{https://github.com/theKashey/react-remove-scroll/blob/666472d5c77fb6c4e5beffdde87c53ae63ef42c5/src/SideEffect.tsx\#L166}{\texttt{Effect for react-\/remove-\/scroll}} -\/ 300b UI, 2kb sidecar\hypertarget{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7456}{}\doxysubsection{\texorpdfstring{Licence}{Licence}}\label{dir_a03221562eb905056bf27ed9059e3454_autotoc_md7456}
MIT 