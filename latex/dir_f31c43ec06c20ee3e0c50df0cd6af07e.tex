...
\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1992}{}\doxysubsection{\texorpdfstring{d3-\/color}{d3-\/color}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1992}
...
In addition to the ubiquitous and machine-\/friendly \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}{RGB} and \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hsl}{HSL} color space, d3-\/color supports color spaces that are designed for humans\+:


\begin{DoxyItemize}
\item \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lab}{CIELAB} ({\itshape a.\+k.\+a.} “\+Lab”)
\item \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lch}{CIELCh\textsubscript{ab}} ({\itshape a.\+k.\+a.} “\+LCh” or “\+HCL”)
\item Dave Green’s \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_cubehelix}{Cubehelix}
\end{DoxyItemize}

Cubehelix features monotonic lightness, while CIELAB and its polar form CIELCh\textsubscript{ab} are perceptually uniform.\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1993}{}\doxysubsection{\texorpdfstring{Extensions}{Extensions}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1993}
...
\end{DoxyItemize}\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1994}{}\doxysubsection{\texorpdfstring{Installing}{Installing}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1994}
...
\href{https://observablehq.com/collection/@d3/d3-color}{\texttt{Try d3-\/color in your browser.}}\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1995}{}\doxysubsection{\texorpdfstring{API Reference}{API Reference}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md1995}
...
Parses the specified \href{http://www.w3.org/TR/css3-color/\#colorunits}{\texttt{CSS Color Module Level 3}} {\itshape specifier} string, returning an \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}{RGB} or \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hsl}{HSL} color, along with \href{https://www.w3.org/TR/css-color-4/\#hex-notation}{\texttt{CSS Color Module Level 4 hex}} {\itshape specifier} strings. If the specifier was not valid, null is returned. Some examples\+:
...
Returns the \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}{RGB equivalent} of this color. For RGB colors, that’s {\ttfamily this}.
...
An alias for \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatRgb}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}.format\+Rgb}.
...
If {\itshape r}, {\itshape g} and {\itshape b} are specified, these represent the channel values of the returned color; an {\itshape opacity} may also be specified. If a CSS Color Module Level 3 {\itshape specifier} string is specified, it is parsed and then converted to the RGB color space. See \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color}{color} for examples. If a \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}} instance is specified, it is converted to the RGB color space using \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_rgb}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}.rgb}. Note that unlike \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_rgb}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}.rgb} this method {\itshape always} returns a new instance, even if {\itshape color} is already an RGB color.
...
Constructs a new \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lab}{CIELAB} color with the specified {\itshape l} value and {\itshape a} = {\itshape b} = 0.
...
Equivalent to \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lch}{d3.lch}, but with reversed argument order.
