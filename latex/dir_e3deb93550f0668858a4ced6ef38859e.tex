...
\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3213}{}\doxysubsection{\texorpdfstring{flat-\/cache}{flat-\/cache}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3213}
\begin{quote}
A stupidly simple key/value storage using files to persist the data \end{quote}


\href{https://npmjs.org/package/flat-cache}{\texttt{}} \href{https://github.com/jaredwray/flat-cache/actions/workflows/tests.yaml}{\texttt{}} \href{https://codecov.io/github/jaredwray/flat-cache}{\texttt{}} \href{https://npmjs.com/package/flat-cache}{\texttt{}}\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3214}{}\doxysubsection{\texorpdfstring{install}{install}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3214}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ i\ -\/-\/save\ flat-\/cache}

\end{DoxyCode}
\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3215}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3215}
...
\end{DoxyCode}
\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3216}{}\doxysubsection{\texorpdfstring{Motivation for this module}{Motivation for this module}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3216}
I needed a super simple and dumb {\bfseries{in-\/memory cache}} with optional disk persistance in order to make a script that will beutify files with {\ttfamily esformatter} only execute on the files that were changed since the last run. To make that possible we need to store the {\ttfamily file\+Size} and {\ttfamily modification\+Time} of the files. So a simple {\ttfamily key/value} storage was needed and Bam! this module was born.\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3217}{}\doxysubsection{\texorpdfstring{Important notes}{Important notes}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3217}
...
\end{DoxyItemize}\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3218}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3218}
MIT\hypertarget{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3219}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{dir_e3deb93550f0668858a4ced6ef38859e_autotoc_md3219}
