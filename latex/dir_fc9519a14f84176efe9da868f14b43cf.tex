\doxysection{frontend/node\+\_\+modules/foreground-\/child Directory Reference}
\hypertarget{dir_fc9519a14f84176efe9da868f14b43cf}{}\label{dir_fc9519a14f84176efe9da868f14b43cf}\index{frontend/node\_modules/foreground-\/child Directory Reference@{frontend/node\_modules/foreground-\/child Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3237}{}\doxysubsection{\texorpdfstring{foreground-\/child}{foreground-\/child}}\label{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3237}
Run a child as if it\textquotesingle{}s the foreground process. Give it stdio. Exit when it exits.

Mostly this module is here to support some use cases around wrapping child processes for test coverage and such. But it\textquotesingle{}s also generally useful any time you want one program to execute another as if it\textquotesingle{}s the "{}main"{} process, for example, if a program takes a {\ttfamily -\/-\/cmd} argument to execute in some way.\hypertarget{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3238}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3238}
...
If the callback returns a string value, then that will be used as the signal to exit the parent process. If it returns a number, then that number will be used as the parent exit status code. If it returns boolean {\ttfamily false}, then the parent process will not be terminated. If it returns {\ttfamily undefined}, then it will exit with the same signal/code as the child process.\hypertarget{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3239}{}\doxysubsection{\texorpdfstring{Caveats}{Caveats}}\label{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3239}
...
It doesn\textquotesingle{}t go in the other direction; ie, signals sent to the child process will not affect the parent. For that, listen to the child {\ttfamily exit} or {\ttfamily close} events, and handle them appropriately.\hypertarget{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3241}{}\doxysubsection{\texorpdfstring{util\+: {\ttfamily foreground-\/child/watchdog}}{util\+: {\ttfamily foreground-\/child/watchdog}}}\label{dir_fc9519a14f84176efe9da868f14b43cf_autotoc_md3241}
