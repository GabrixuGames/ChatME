...
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3220}{}\doxysubsection{\texorpdfstring{flatted}{flatted}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3220}
...
\DoxyHorRuler{0}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3221}{}\doxysubsection{\texorpdfstring{Announcement 📣}{Announcement 📣}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3221}
...
\end{DoxyCode}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3222}{}\doxysubsection{\texorpdfstring{to\+JSON and from\+JSON}{to\+JSON and from\+JSON}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3222}
...
\end{DoxyCode}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3223}{}\doxysubsection{\texorpdfstring{Flatted VS JSON}{Flatted VS JSON}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3223}
...
Also please note this project serializes and deserializes only data compatible with JSON, so that sockets, or anything else with internal classes different from those allowed by JSON standard, won\textquotesingle{}t be serialized and unserialized as expected.\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3224}{}\doxysubsubsection{\texorpdfstring{New in V1\+: Exact same JSON API}{New in V1\+: Exact same JSON API}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3224}
...
\end{DoxyItemize}\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3225}{}\doxysubsubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3225}
All ECMAScript engines compatible with {\ttfamily Map}, {\ttfamily Set}, {\ttfamily Object.\+keys}, and {\ttfamily Array.\+prototype.\+reduce} will work, even if polyfilled.\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md3226}{}\doxysubsubsection{\texorpdfstring{How does it work ?}{How does it work ?}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md3226}
