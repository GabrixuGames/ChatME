...
\label{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md2439}%
\Hypertarget{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md2439}%
...
The tokens are different from Moment.\+js and other libraries that opted to use custom formatting rules. While usage of a standard ensures compatibility and the future of the library, it causes confusion that this document intends to resolve.\hypertarget{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md2440}{}\doxysection{\texorpdfstring{Popular mistakes}{Popular mistakes}}\label{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md2440}
