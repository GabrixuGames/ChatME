\doxysection{frontend/node\+\_\+modules/use-\/callback-\/ref Directory Reference}
\hypertarget{dir_6915789bca8091d63f16f575762b0f8d}{}\label{dir_6915789bca8091d63f16f575762b0f8d}\index{frontend/node\_modules/use-\/callback-\/ref Directory Reference@{frontend/node\_modules/use-\/callback-\/ref Directory Reference}}


\doxysubsection{Detailed Description}
 \doxysubsection*{🤙 use-\/callback-\/ref 📞}
...
All functions are tree shakable, but even together it\textquotesingle{}s {\bfseries{less then 300b}}.\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7421}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7421}
💡 Some commands are hooks based, and returns the same refs/functions every render. But some are not, to be used in classes or non-\/react code.\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7422}{}\doxysubsubsection{\texorpdfstring{use\+Ref API}{use\+Ref API}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7422}
🤔 Use case\+: every time you have to react to ref change

API is 99\% compatible with React {\ttfamily create\+Ref} and {\ttfamily use\+Ref}, and just adds another argument -\/ {\ttfamily callback}, which would be called on {\bfseries{ref update}}.\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7423}{}\doxysubsubsubsubsection{\texorpdfstring{create\+Callback\+Ref -\/ to replace React.\+create\+Ref}{create\+Callback\+Ref -\/ to replace React.\+create\+Ref}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7423}

\begin{DoxyItemize}
\item {\ttfamily create\+Callback\+Ref(callback)} -\/ would call provided {\ttfamily callback} when ref is changed.
\end{DoxyItemize}\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7424}{}\doxysubsubsubsubsection{\texorpdfstring{use\+Callback\+Ref -\/ to replace React.\+use\+Ref}{use\+Callback\+Ref -\/ to replace React.\+use\+Ref}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7424}
...
\end{DoxyCode}
\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7425}{}\doxysubsubsection{\texorpdfstring{assign\+Ref}{assign\+Ref}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7425}
...
\end{DoxyCode}
\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7426}{}\doxysubsubsection{\texorpdfstring{use\+Transform\+Ref (to replace React.\+use\+Imperative\+Handle)}{use\+Transform\+Ref (to replace React.\+use\+Imperative\+Handle)}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7426}
...
\end{DoxyCode}
\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7427}{}\doxysubsubsection{\texorpdfstring{ref\+To\+Callback}{ref\+To\+Callback}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7427}
{\ttfamily ref\+To\+Callback(ref\+: Ref\+Object)\+: Ref\+Callback} -\/ for compatibility between the old and the new code. For the compatibility between {\ttfamily Ref\+Callback} and Ref\+Object use {\ttfamily use\+Callback\+Ref(undefined, callback)}\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7428}{}\doxysubsubsection{\texorpdfstring{use\+Merge\+Refs}{use\+Merge\+Refs}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7428}
...
💡 -\/ {\ttfamily use\+Merge\+Refs} will always give you the same return, and you don\textquotesingle{}t have to worry about {\ttfamily \mbox{[}local\+Ref, ref\mbox{]}} unique every render.\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7429}{}\doxysubsubsection{\texorpdfstring{merge\+Refs}{merge\+Refs}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7429}
...
{\ttfamily merge\+Refs} are "{}safe"{} to use as a part of other hooks-\/based commands, but don\textquotesingle{}t forget -\/ it returns a new object every call.\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7430}{}\doxysubsection{\texorpdfstring{Similar packages\+:}{Similar packages\+:}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7430}
...
\hypertarget{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7432}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_6915789bca8091d63f16f575762b0f8d_autotoc_md7432}
MIT 