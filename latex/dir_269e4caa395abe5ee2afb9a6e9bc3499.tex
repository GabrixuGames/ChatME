...
\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1944}{}\doxysubsection{\texorpdfstring{cross-\/spawn}{cross-\/spawn}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1944}
...
A cross platform solution to node\textquotesingle{}s spawn and spawn\+Sync.\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1945}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1945}
Node.\+js version 8 and up\+: {\ttfamily \$ npm install cross-\/spawn}

Node.\+js version 7 and under\+: {\ttfamily \$ npm install cross-\/spawn@6}\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1946}{}\doxysubsection{\texorpdfstring{Why}{Why}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1946}
...
All these issues are handled correctly by {\ttfamily cross-\/spawn}. There are some known modules, such as \href{https://github.com/ForbesLindesay/win-spawn}{\texttt{win-\/spawn}}, that try to solve this but they are either broken or provide faulty escaping of shell arguments.\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1947}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1947}
...
\end{DoxyCode}
\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1948}{}\doxysubsection{\texorpdfstring{Caveats}{Caveats}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1948}
\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1949}{}\doxysubsubsection{\texorpdfstring{Using {\ttfamily options.\+shell} as an alternative to {\ttfamily cross-\/spawn}}{Using {\ttfamily options.\+shell} as an alternative to {\ttfamily cross-\/spawn}}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1949}
...
If you are using the {\ttfamily shell} option to spawn a command in a cross platform way, consider using {\ttfamily cross-\/spawn} instead. You have been warned.\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1950}{}\doxysubsubsection{\texorpdfstring{{\ttfamily options.\+shell} support}{{\ttfamily options.\+shell} support}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1950}
...
This mimics the Node.\+js behavior. More specifically, the command and its arguments will not be automatically escaped nor shebang support will be offered. This is by design because if you are using {\ttfamily options.\+shell} you are probably targeting a specific platform anyway and you don\textquotesingle{}t want things to get into your way.\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1951}{}\doxysubsubsection{\texorpdfstring{Shebangs support}{Shebangs support}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1951}
...
Remember to always test your code on Windows!\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1952}{}\doxysubsection{\texorpdfstring{Tests}{Tests}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1952}
{\ttfamily \$ npm test} ~\newline
 {\ttfamily \$ npm test -\/-\/ -\/-\/watch} during development\hypertarget{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1953}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_269e4caa395abe5ee2afb9a6e9bc3499_autotoc_md1953}
