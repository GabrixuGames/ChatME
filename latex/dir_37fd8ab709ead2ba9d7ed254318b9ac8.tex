\doxysection{frontend/node\+\_\+modules/jackspeak Directory Reference}
\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8}{}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8}\index{frontend/node\_modules/jackspeak Directory Reference@{frontend/node\_modules/jackspeak Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3846}{}\doxysubsection{\texorpdfstring{jackspeak}{jackspeak}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3846}
...
Unless otherwise noted, all methods return the object itself.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3847}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3847}
...
\end{DoxyCode}
\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3848}{}\doxysubsection{\texorpdfstring{{\ttfamily jack(options\+: Jack\+Options = \{\}) =\texorpdfstring{$>$}{>} Jack}}{{\ttfamily jack(options\+: Jack\+Options = \{\}) =\texorpdfstring{$>$}{>} Jack}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3848}
...
Boolean values are written as {\ttfamily \textquotesingle{}1\textquotesingle{}} and {\ttfamily \textquotesingle{}0\textquotesingle{}}, and will be treated as {\ttfamily true} if they\textquotesingle{}re {\ttfamily \textquotesingle{}1\textquotesingle{}} or false otherwise.
...
\end{DoxyItemize}\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3849}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+heading(text\+: string, level?\+: 1 \texorpdfstring{$\vert$}{|} 2 \texorpdfstring{$\vert$}{|} 3 \texorpdfstring{$\vert$}{|} 4 \texorpdfstring{$\vert$}{|} 5 \texorpdfstring{$\vert$}{|} 6)}}{{\ttfamily Jack.\+heading(text\+: string, level?\+: 1 \texorpdfstring{$\vert$}{|} 2 \texorpdfstring{$\vert$}{|} 3 \texorpdfstring{$\vert$}{|} 4 \texorpdfstring{$\vert$}{|} 5 \texorpdfstring{$\vert$}{|} 6)}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3849}
...
Headings level 1 and 2 will have a line of padding underneath them. Headings level 3 through 6 will not.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3850}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+description(text\+: string, \{ pre?\+: boolean \} = \{\})}}{{\ttfamily Jack.\+description(text\+: string, \{ pre?\+: boolean \} = \{\})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3850}
Define a long string description, used in the {\ttfamily usage()} output.

If the {\ttfamily pre} option is set to {\ttfamily true}, then whitespace will not be normalized. However, if any line is too long for the width allotted, it will still be wrapped.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3851}{}\doxysubsection{\texorpdfstring{Option Definitions}{Option Definitions}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3851}
...
\begin{DoxyItemize}
\item {\ttfamily type} Only needed for the {\ttfamily add\+Fields} method, as the others set it implicitly. Can be {\ttfamily \textquotesingle{}string\textquotesingle{}}, {\ttfamily \textquotesingle{}boolean\textquotesingle{}}, or {\ttfamily \textquotesingle{}number\textquotesingle{}}.
\item {\ttfamily multiple} Only needed for the {\ttfamily add\+Fields} method, as the others set it implicitly. Set to {\ttfamily true} to define an array type. This means that it can be set on the CLI multiple times, set as an array in the {\ttfamily values} and it is represented in the environment as a delimited string.
\item {\ttfamily short} A one-\/character shorthand for the option.
\item {\ttfamily description} Some words to describe what this option is and why you\textquotesingle{}d set it.
\item {\ttfamily hint} (Only relevant for non-\/boolean types) The thing to show in the usage output, like {\ttfamily -\/-\/option=\texorpdfstring{$<$}{<}hint\texorpdfstring{$>$}{>}}
\item {\ttfamily validate} A function that returns false (or throws) if an option value is invalid.
\item {\ttfamily valid\+Options} An array of strings or numbers that define the valid values that can be set. This is not allowed on {\ttfamily boolean} (flag) options. May be used along with a {\ttfamily validate()} method.
...
\end{DoxyItemize}\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3852}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+flag(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+flag(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3852}
...
If a boolean option named {\ttfamily no-\/\$\{option\+Name\}} with the same {\ttfamily multiple} setting is in the configuration, then that will be treated as a negating flag.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3853}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+flag\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+flag\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3853}
Define one or more boolean array fields.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3854}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+num(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+num(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3854}
Define one or more number fields. These will be set in the environment as a stringified number, and included in the {\ttfamily values} object as a number.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3855}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+num\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+num\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3855}
Define one or more number list fields. These will be set in the environment as a delimited set of stringified numbers, and included in the {\ttfamily values} as a number array.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3856}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+opt(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+opt(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3856}
Define one or more string option fields.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3857}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+opt\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+opt\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3857}
Define one or more string list fields.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3858}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+add\+Fields(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+add\+Fields(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3858}
Define one or more fields of any type. Note that {\ttfamily type} and {\ttfamily multiple} must be set explicitly on each definition when using this method.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3859}{}\doxysubsection{\texorpdfstring{Actions}{Actions}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3859}
Use these methods on a Jack object that\textquotesingle{}s already had its config fields defined.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3860}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+parse(args\+: string\mbox{[}\mbox{]} = process.\+argv)\+: \{ positionals\+: string\mbox{[}\mbox{]}, values\+: Options\+Results \}}}{{\ttfamily Jack.\+parse(args\+: string\mbox{[}\mbox{]} = process.\+argv)\+: \{ positionals\+: string\mbox{[}\mbox{]}, values\+: Options\+Results \}}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3860}
Parse the arguments list, write to the environment if {\ttfamily env\+Prefix} is set, and returned the parsed values and remaining positional arguments.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3861}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+validate(o\+: any)\+: asserts o is Options\+Results}}{{\ttfamily Jack.\+validate(o\+: any)\+: asserts o is Options\+Results}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3861}
Throws an error if the object provided is not a valid result set, for the configurations defined thusfar.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3862}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+usage()\+: string}}{{\ttfamily Jack.\+usage()\+: string}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3862}
Returns the compiled {\ttfamily usage} string, with all option descriptions and heading/description text, wrapped to the appropriate width for the terminal.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3863}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+set\+Config\+Values(options\+: Options\+Results, src?\+: string)}}{{\ttfamily Jack.\+set\+Config\+Values(options\+: Options\+Results, src?\+: string)}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3863}
Validate the {\ttfamily options} argument, and set the default value for each field that appears in the options.

Values provided will be overridden by environment variables or command line arguments.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3864}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+usage\+Markdown()\+: string}}{{\ttfamily Jack.\+usage\+Markdown()\+: string}}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3864}
Returns the compiled {\ttfamily usage} string, with all option descriptions and heading/description text, but as markdown instead of formatted for a terminal, for generating HTML documentation for your CLI.\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3865}{}\doxysubsection{\texorpdfstring{Some Example Code}{Some Example Code}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3865}
...
\end{DoxyCode}
\hypertarget{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3866}{}\doxysubsection{\texorpdfstring{Name}{Name}}\label{dir_37fd8ab709ead2ba9d7ed254318b9ac8_autotoc_md3866}
