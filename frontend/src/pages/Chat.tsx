...
const Chat = () => {
  ...
  const publicRooms = rooms.filter((room) => room.room_type !== "individual");
            ...
            <div className="w-full max-w-md text-foreground">
              <div className="relative overflow-hidden rounded-3xl border border-border bg-card shadow-xl">
                ...
                <div className="px-6 pt-8 pb-6 text-center">
                  ...
                  <div className="mt-3 text-lg font-semibold">{user || "Usuario"}</div>
              ...
              <div className="mt-5 rounded-2xl border border-border bg-card p-4 shadow-sm">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="friends">
                    ...
                    <AccordionContent>
                      <FriendsPanel onRoomSelect={handleRoomSelect} />
                    </AccordionContent>
                  </AccordionItem>
            ...
            <div className="w-full max-w-3xl text-foreground">
              <div className="relative overflow-hidden rounded-3xl border border-border bg-card shadow-xl">
                ...
                <div className="flex items-center gap-6 p-10">
                  ...
                  <div>
                    <div className="text-3xl font-semibold">{user || "Usuario"}</div>
