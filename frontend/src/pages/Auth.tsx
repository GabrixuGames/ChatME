...
export default function AuthPage() {
  ...
  return (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-100 to-purple-300 relative overflow-hidden px-2 sm:px-0">
      <BubbleBackground />
  ...
  <div className="perspective w-full">
          ...
          >
            {/* Front face */}
            <div
              className={`absolute inset-0 flex flex-col justify-center items-center bg-white/80 shadow-2xl rounded-2xl p-4 sm:p-8 backdrop-blur-md transition-transform duration-700 ${flipped === "none" ? "z-20" : "z-10"}`}
              style={{
            ...
            >
              ...
              <p className="text-gray-600 mb-6 text-center text-base sm:text-lg">Conéctate, chatea y haz nuevos amigos en una plataforma moderna, divertida y segura.</p>
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full mb-4">
                <button
                  className="flex-1 py-3 px-4 rounded-lg bg-purple-600 text-white font-semibold shadow-lg hover:bg-purple-700 hover:scale-105 transition-all duration-150 text-base sm:text-lg"
                  onClick={() => setFlipped("login")}
                >
                  Iniciar sesión
                </button>
                <button
                  className="flex-1 py-3 px-4 rounded-lg bg-white text-purple-600 font-semibold border border-purple-600 shadow-lg hover:bg-purple-50 hover:scale-105 transition-all duration-150 text-base sm:text-lg"
            ...
            {/* Back face */}
            <div
              className={`absolute inset-0 flex flex-col justify-center items-center bg-white/80 shadow-2xl rounded-2xl p-8 backdrop-blur-md transition-transform duration-700 ${flipped !== "none" ? "z-20" : "z-10"}`}
              style={{
                backfaceVisibility: "hidden",
                transform: flipped !== "none" ? "rotateY(0deg)" : "rotateY(180deg)"
              }}
